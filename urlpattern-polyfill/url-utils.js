...
function validatePatternEncoding(pattern, component) {
    if (!pattern.length)
        return pattern;
...
export function canonicalizePathname(pathname, isPattern) {
    if (isPattern) {
...
export function canonicalizePort(port, isPattern) {
    if (isPattern) {
